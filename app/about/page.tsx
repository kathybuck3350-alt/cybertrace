              ...
              <div className="prose prose-lg max-w-none">
                <div className="bg-gray-50 rounded-2xl p-8 mb-8 border border-gray-200">
                  ...
                  <p className="text-gray-700 leading-relaxed mb-4">
                    CyberRecovery is dedicated to securing the cryptocurrency ecosystem through world-class blockchain intelligence, advanced forensics, and comprehensive AML compliance solutions. We empower organizations and individuals to navigate the digital asset landscape safely and confidently.
                  </p>
                ...
                <div className="bg-gray-50 rounded-2xl p-8 mb-8 border border-gray-200">
                  ...
                  <p className="text-gray-700 leading-relaxed mb-4">
                    Founded with a vision to revolutionize cryptocurrency security, CyberRecovery has grown from a pioneering startup to a trusted global leader in blockchain intelligence. Our journey began with a simple yet powerful goal: to make cryptocurrency safer for everyone.
                  </p>
                  <p className="text-gray-700 leading-relaxed">
